...
def monkey_open(self, url):
    ...
    if protocol == self.protocol or (
                protocol == 'http' and location == 'www.w3.org/2001/xml.xsd'):
        return self.find(location)    
    else:
        return None

suds.store.DocumentStore.open = monkey_open

# Otherwise suds will try, and often fail, to download this document.
suds.store.DocumentStore.store['www.w3.org/2001/xml.xsd'] = """<?xml version='1.0'?>
